...
const DEMO_SUGGESTIONS = [
  ...
  },
  {
    ...
    reasoning: 'Questions drive 1.6x more impressions in your analytics. This format invites replies which boost algorithmic reach.',
  ...
  },
  {
    ...
    reasoning: 'Numbered lists with personal experience get 1.4x engagement. Thread-style content is your highest performing post type.',
  ...
  },
  {
    ...
    reasoning: 'Hot takes and contrarian opinions drive high engagement in your analytics. Posts with "unpopular opinion" framing tend to get 2x reply rates.',
    target_metric: 'engagement',
    created_at: new Date(Date.now() - 3600000).toISOString(),
    used: 0,
  },
